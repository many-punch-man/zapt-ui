  ...
  <div class="min-w-fit">
    ...
    <div id="sidebar" ref="sidebar"
      ...
      <div class="space-y-8">
        ...
        <!--            </svg>-->
        <!--            <span-->
        <!--                class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">E-Commerce-->
        <!--            </span>-->
        <!--          </div>-->
        <!--          &lt;!&ndash; Icon &ndash;&gt;-->
        <!--          <div class="flex shrink-0 ml-2">-->
        ...
        <!--      <a class="block text-gray-800 dark:text-gray-100 truncate transition"-->
        <!--         :class="currentRoute.fullPath.includes('settings') ? '' : 'hover:text-gray-900 dark:hover:text-white'"-->
        <!--         href="#0" @click.prevent="parentLink.handleClick(); sidebarExpanded = true">-->
        <!--        <div class="flex items-center justify-between">-->
        <!--          <div class="flex items-center">-->
        <!--            <svg class="shrink-0 fill-current"-->
        ...
        <!--      <a class="block text-gray-800 dark:text-gray-100 truncate transition"-->
        <!--         :class="currentRoute.fullPath.includes('utility') ? '' : 'hover:text-gray-900 dark:hover:text-white'"-->
        <!--         href="#0" @click.prevent="parentLink.handleClick(); sidebarExpanded = true">-->
        <!--        <div class="flex items-center justify-between">-->
        <!--          <div class="flex items-center">-->
        <!--            <svg class="shrink-0 fill-current"-->
        <!--                 :class="currentRoute.fullPath.includes('utility') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'"-->
        <!--                 xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">-->
        <!--              <path-->
        ...
        <!--      <a class="block text-gray-800 dark:text-gray-100 truncate transition"-->
        <!--         :class="currentRoute.fullPath.includes('component') ? '' : 'hover:text-gray-900 dark:hover:text-white'"-->
        <!--         href="#0" @click.prevent="parentLink.handleClick(); sidebarExpanded = true">-->
        <!--        <div class="flex items-center justify-between">-->
        <!--          <div class="flex items-center">-->
        <!--            <svg class="shrink-0 fill-current"-->
        <!--                 :class="currentRoute.fullPath.includes('component') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'"-->
        <!--                 xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">-->
        <!--              <path-->
        ...
        <!--            </svg>-->
        <!--            <span-->
        <!--                class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Components-->
        <!--            </span>-->
        <!--          </div>-->
        <!--          &lt;!&ndash; Icon &ndash;&gt;-->
        <!--          <div class="flex shrink-0 ml-2">-->

<template>
  <header
      ...
      dark:max-lg:before:bg-gray-800/90 before:-z-10 z-30  before:transition-all before:duration-200 before:ease-in-out"
      :class="[
...
import {ref} from 'vue'
import DropdownNotifications from "~/components/admin/DropdownNotifications.vue";
import SearchModal from "~/components/admin/SearchModal.vue";
import DropdownHelp from "~/components/admin/DropdownHelp.vue";
import ThemeToggle from "~/components/admin/ThemeToggle.vue";
import DropdownProfile from "~/components/admin/DropdownProfile.vue";

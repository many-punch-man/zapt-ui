      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="relative max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-xl shadow-md mb-8 relative before:absolute before:-top-12 before:w-52 before:h-52 before:bg-zinc-900 before:opacity-[.08] before:rounded-full before:blur-3xl before:-z-10">
            <img src="/assets/images/logo-02.png" width="60" height="60" alt="Logo">
          </div>
        ...
        <div class="text-center">
          <ul class="inline-flex flex-wrap items-center justify-center -m-3">
            <li class="m-3">
            ...
            <li class="m-3">
              <svg class="fill-zinc-400" xmlns="http://www.w3.org/2000/svg" width="40" height="40" aria-label="Slack">
            ...
            <li class="m-3">
              <svg class="fill-zinc-400" xmlns="http://www.w3.org/2000/svg" width="40" height="40" aria-label="Amazon">

            ...
            <div class="relative flex flex-col">
              ...
              >              
                <div class="w-full" v-show="tab === '1'">
                  <div>
                    <img class="lg:max-w-none mx-auto rounded-lg shadow-2xl" src="/assets/images/carousel-illustration-01.jpg" width="800" height="620" alt="Carousel 01" />
                  </div>
                </div>
              </transition>
              <!-- Item 2 -->
              ...
              >              
                <div class="w-full" v-show="tab === '2'">
                  <div>
                    <img class="lg:max-w-none mx-auto rounded-lg shadow-2xl" src="/assets/images/carousel-illustration-01.jpg" width="800" height="620" alt="Carousel 02" />
                  </div>
                </div>
              </transition>
              <!-- Item 3 -->
              ...
              >              
                <div class="w-full" v-show="tab === '3'">
                  <div>
                    <img class="lg:max-w-none mx-auto rounded-lg shadow-2xl" src="/assets/images/carousel-illustration-01.jpg" width="800" height="620" alt="Carousel 03" />
                  </div>
                </div>
              </transition>
            </div>
            <!-- Gear illustration -->
            <img class="absolute left-0 bottom-0 -translate-x-1/2 translate-y-1/3 mix-blend-exclusion max-lg:w-32" src="/assets/images/features-02-illustration.png" alt="Features 02 illustration" width="173" height="167" aria-hidden="true">
          </div>

    ...
    <div class="pt-32 pb-12 md:pt-40 md:pb-20">
      ...
      <div class="px-4 sm:px-6">
        <div class="relative max-w-3xl mx-auto">
          <img class="absolute left-full bottom-20 ml-8 -z-10 pointer-events-none mix-blend-exclusion" src="/assets/images/hero-illustration.png" width="165" height="149" alt="Hero illustration" aria-hidden="true">
          <div class="text-center pb-12 md:pb-16">
            <h1 class="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">The creative
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 flex justify-center pb-12 md:pb-20 relative before:absolute before:-top-12 before:w-96 before:h-96 before:bg-zinc-900 before:opacity-[.15] before:rounded-full before:blur-3xl before:-z-10">
        <img class="rounded-lg shadow-2xl" src="/assets/images/hero-image.png" width="1104" height="620" alt="Hero">
      </div>

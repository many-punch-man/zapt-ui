          ...
          <form>
            <div class="flex flex-wrap -mx-3 mb-4">
              <div class="w-full px-3">
                ...
                <input id="account" type="account" class="form-input w-full text-gray-300" placeholder="you@yourcompany.com" autocomplete="true" required />
              </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-4">
              <div class="w-full px-3">
                <label class="block text-gray-300 text-sm font-medium mb-1" for="password">Password</label>
                <input id="password" type="password" class="form-input w-full text-gray-300" placeholder="Password (at least 10 characters)" autocomplete="true" required />
              </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-4">
              <div class="w-full px-3">
